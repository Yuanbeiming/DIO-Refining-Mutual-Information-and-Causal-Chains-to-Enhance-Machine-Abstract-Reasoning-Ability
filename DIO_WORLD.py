...
class raven_clip(nn.Module):
    ...
    def forward(self, x):
        ...
        #x, vq_loss, encoding_index = self.vql(x)
    ...
    def loss_function(self, *out, target_shape, target_line, idx):
        ...
        return 100*loss + 50*loss_3 + 1*loss_4 + 1*loss_5 + 10*vq_loss,   loss,  vq_loss, right
    ...
    def dio_loss(self, logits, target, delta= 1e-3, gumbeling = True):
